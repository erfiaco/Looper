...
input_device = 'audioinjector-pi-soundcard'  # Para grabaci
output_device = 'audioinjector-pi-soundcard'  # Para reproducció
...
# Grabacion
if grabando:
    with sd.InputStream(samplerate=sample_rate, channels=channels, callback=callback, device=input_device):
        while grabando:
            sd.sleep(200)
